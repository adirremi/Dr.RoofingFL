...
export const projects: Project[] = [
...

  {
    ...
    priceRange: 'On request / insurance (varies)',
    ...
    summary:
      'Full insurance-covered roof replacement in Pembroke Falls after Hurricane Ian damage. Upgraded to Class-4 impact-rated GAF UHDZ; out-of-pocket depends on your policy and deductible.',
    fullDescription:
      "This 28-square home in the Pembroke Falls master-planned community suffered significant wind damage during Hurricane Ian (2022), with over 60 missing or lifted shingles, damaged pipe boots, and visible water intrusion in the attic. The homeowner filed an insurance claim that was initially denied as 'age-related wear.' We performed a free post-storm inspection with drone photography, moisture-meter readings, and a Xactimate-compliant scope of work documenting the storm-related damage separately from any pre-existing condition. When the insurance adjuster came out, our project manager met them on-site and walked them through the damage item-by-item. The claim was approved with a written scope for a full roof replacement. We then helped the homeowner review a supplemental upgrade to Class-4 impact-rated GAF Timberline UHDZ shingles. Insurance credits and your final out-of-pocket depend on your specific policy. The installation took 2 days — complete tear-off, synthetic underlayment with ice-and-water shield at eaves, valleys, and penetrations, GAF Timberline UHDZ shingles in Charcoal with a 6-nail pattern, all flashings and pipe boots replaced, and a ridge vent for ventilation. The homeowner received a GAF Golden Pledge limited warranty and our written workmanship terms per the contract. Ask your insurance agent about possible wind-hail premium impacts.",
    challenges: [
    ...
    outcome:
      'Claim approved, Class-4 upgrade installed, manufacturer and workmanship terms documented per job agreement.',
    latitude: 26.0082,
    longitude: -80.3373,
  },
