...
export const locations: Record<string, LocationData> = {
  hollywood: {
    ...
    projects: [
      { title: 'Concrete Tile Replacement', neighborhood: 'Emerald Hills', service: 'Tile Roof', image: '/tile_roofing.jpeg' },
      { title: 'Standing-Seam Metal Reroof', neighborhood: 'Hollywood Hills', service: 'Metal Roof', image: '/metal_roofing.jpg' },
      { title: 'Architectural Shingle Install', neighborhood: 'Driftwood', service: 'Shingle Roof', image: '/shingle_roofing.jpeg' },
      { title: 'TPO Flat Roof System', neighborhood: 'Downtown Hollywood', service: 'Flat / TPO', image: '/flat_roofing.jpeg' },
      { title: 'Hurricane Damage Restoration', neighborhood: 'Hollywood Beach', service: 'Storm Damage', image: '/tile_roofing.jpeg' },
      { title: 'Clay Tile Replacement', neighborhood: 'Hollywood Lakes', service: 'Tile Roof', image: '/tile_roofing.jpeg' },
      { title: 'GAF Timberline HDZ Install', neighborhood: 'Washington Park', service: 'Shingle Roof', image: '/shingle_roofing.jpeg' },
      { title: 'Aluminum Metal Roof', neighborhood: 'Liberia', service: 'Metal Roof', image: '/metal_roofing.jpg' },
      { title: 'Commercial TPO Roof', neighborhood: 'Park East', service: 'Flat / TPO', image: '/flat_roofing.jpeg' },
      { title: 'Residential Leak Repair', neighborhood: 'Oakridge', service: 'Roof Repair', image: '/shingle_roofing.jpeg' },
      { title: 'Full Tile Replacement', neighborhood: 'West Lake', service: 'Tile Roof', image: '/tile_roofing.jpeg' },
      { title: 'Storm Tarp-Up Emergency', neighborhood: 'Hollywood Gardens', service: 'Storm Damage', image: '/metal_roofing.jpg' },
    ],
    reviews: [
  ...
  miami: {
    ...
    projects: [
      { title: 'Clay Tile Replacement', neighborhood: 'Coral Gables', service: 'Tile Roof', image: '/tile_roofing.jpeg' },
      { title: 'Standing-Seam Aluminum Roof', neighborhood: 'Coconut Grove', service: 'Metal Roof', image: '/metal_roofing.jpg' },
      { title: 'GAF Timberline HDZ Install', neighborhood: 'Kendall', service: 'Shingle Roof', image: '/shingle_roofing.jpeg' },
      { title: 'TPO Flat Roof — Commercial', neighborhood: 'Wynwood', service: 'Flat / TPO', image: '/flat_roofing.jpeg' },
      { title: 'Condo Flat Roof Replacement', neighborhood: 'Brickell', service: 'Flat / TPO', image: '/flat_roofing.jpeg' },
      { title: 'Concrete Tile Roof', neighborhood: 'Pinecrest', service: 'Tile Roof', image: '/tile_roofing.jpeg' },
      { title: 'Hurricane Damage Restoration', neighborhood: 'Palmetto Bay', service: 'Storm Damage', image: '/metal_roofing.jpg' },
      { title: 'Metal Mansard Replacement', neighborhood: 'Little Havana', service: 'Metal Roof', image: '/metal_roofing.jpg' },
      { title: 'Emergency Leak Repair', neighborhood: 'Edgewater', service: 'Roof Repair', image: '/shingle_roofing.jpeg' },
      { title: 'Modified Bitumen Flat Roof', neighborhood: 'Little Haiti', service: 'Flat / TPO', image: '/flat_roofing.jpeg' },
      { title: 'Spanish Tile Re-Roof', neighborhood: 'Cutler Bay', service: 'Tile Roof', image: '/tile_roofing.jpeg' },
      { title: 'Multifamily Shingle Install', neighborhood: 'Downtown Miami', service: 'Shingle Roof', image: '/shingle_roofing.jpeg' },
    ],
    reviews: [
  ...
  fortLauderdale: {
    ...
    projects: [
      { title: 'Concrete Tile Replacement', neighborhood: 'Coral Ridge', service: 'Tile Roof', image: '/tile_roofing.jpeg' },
      { title: 'Aluminum Standing-Seam', neighborhood: 'Harbor Beach', service: 'Metal Roof', image: '/metal_roofing.jpg' },
      { title: 'Shingle Re-Roof', neighborhood: 'Poinsettia Heights', service: 'Shingle Roof', image: '/shingle_roofing.jpeg' },
      { title: 'Commercial TPO Roof', neighborhood: 'Downtown', service: 'Flat / TPO', image: '/flat_roofing.jpeg' },
      { title: 'Historic Tile Restoration', neighborhood: 'Sailboat Bend', service: 'Tile Roof', image: '/tile_roofing.jpeg' },
      { title: 'Storm Damage Claim', neighborhood: 'Imperial Point', service: 'Storm Damage', image: '/shingle_roofing.jpeg' },
      { title: 'Flat Roof TPO', neighborhood: 'Victoria Park', service: 'Flat / TPO', image: '/flat_roofing.jpeg' },
      { title: 'Tile Roof — Waterfront', neighborhood: 'Las Olas Isles', service: 'Tile Roof', image: '/tile_roofing.jpeg' },
      { title: 'Emergency Tarp-Up', neighborhood: 'Rio Vista', service: 'Storm Damage', image: '/metal_roofing.jpg' },
      { title: 'Metal Roof Replacement', neighborhood: 'Lauderdale Harbours', service: 'Metal Roof', image: '/metal_roofing.jpg' },
    ],
    reviews: [
  ...
  pembrokePines: {
    ...
    heroImage: '/shingle_roofing.jpeg',
    mapUrl:
    ...
    projects: [
      { title: 'Concrete Tile Replacement', neighborhood: 'Pembroke Falls', service: 'Tile Roof', image: '/tile_roofing.jpeg' },
      { title: 'GAF Timberline Shingles', neighborhood: 'Silver Lakes', service: 'Shingle Roof', image: '/shingle_roofing.jpeg' },
      { title: 'Owens Corning Duration', neighborhood: 'Chapel Trail', service: 'Shingle Roof', image: '/shingle_roofing.jpeg' },
      { title: 'Metal Mansard Replacement', neighborhood: 'Pembroke Isles', service: 'Metal Roof', image: '/metal_roofing.jpg' },
      { title: 'Hurricane Damage Restore', neighborhood: 'Grand Palms', service: 'Storm Damage', image: '/tile_roofing.jpeg' },
      { title: 'Shingle Re-Roof', neighborhood: 'Sunset Lakes', service: 'Shingle Roof', image: '/shingle_roofing.jpeg' },
      { title: 'Concrete Tile Re-Roof', neighborhood: 'Walnut Creek', service: 'Tile Roof', image: '/tile_roofing.jpeg' },
      { title: 'Flat Roof TPO', neighborhood: 'Century Village', service: 'Flat / TPO', image: '/flat_roofing.jpeg' },
      { title: 'Emergency Leak Repair', neighborhood: 'Towngate', service: 'Roof Repair', image: '/shingle_roofing.jpeg' },
      { title: 'Shingle Install', neighborhood: 'Pembroke Shores', service: 'Shingle Roof', image: '/shingle_roofing.jpeg' },
    ],
    reviews: [
  ...
  miramar: {
    ...
    projects: [
      { title: 'Concrete Tile Replacement', neighborhood: 'Monarch Lakes', service: 'Tile Roof', image: '/tile_roofing.jpeg' },
      { title: 'GAF Shingle Install', neighborhood: 'Riviera Isles', service: 'Shingle Roof', image: '/shingle_roofing.jpeg' },
      { title: 'Standing-Seam Metal', neighborhood: 'Silver Shores', service: 'Metal Roof', image: '/metal_roofing.jpg' },
      { title: 'Commercial TPO Roof', neighborhood: 'Miramar Parkway', service: 'Flat / TPO', image: '/flat_roofing.jpeg' },
      { title: 'Storm Damage Restoration', neighborhood: 'Embassy Lakes', service: 'Storm Damage', image: '/tile_roofing.jpeg' },
      { title: 'Owens Corning Duration', neighborhood: 'Sunset Falls', service: 'Shingle Roof', image: '/shingle_roofing.jpeg' },
      { title: 'Emergency Leak Repair', neighborhood: 'Vizcaya', service: 'Roof Repair', image: '/shingle_roofing.jpeg' },
      { title: 'Warehouse Flat Roof', neighborhood: 'Huntington', service: 'Flat / TPO', image: '/flat_roofing.jpeg' },
      { title: 'Tile Re-Roof', neighborhood: 'Bella Vita', service: 'Tile Roof', image: '/tile_roofing.jpeg' },
      { title: 'Metal Roof', neighborhood: 'Parkland Isles', service: 'Metal Roof', image: '/metal_roofing.jpg' },
    ],
    reviews: [
  ...
  davie: {
    ...
    projects: [
      { title: 'Concrete Tile Replacement', neighborhood: 'Long Lake Ranches', service: 'Tile Roof', image: '/tile_roofing.jpeg' },
      { title: 'Standing-Seam Metal Roof', neighborhood: 'Forest Ridge', service: 'Metal Roof', image: '/metal_roofing.jpg' },
      { title: 'GAF Shingle Re-Roof', neighborhood: 'Shenandoah', service: 'Shingle Roof', image: '/shingle_roofing.jpeg' },
      { title: 'Equestrian Barn Metal Roof', neighborhood: 'Rolling Oaks', service: 'Metal Roof', image: '/metal_roofing.jpg' },
      { title: 'Storm Tarp & Claim', neighborhood: 'Ivanhoe', service: 'Storm Damage', image: '/tile_roofing.jpeg' },
      { title: 'Shingle Replacement', neighborhood: 'Westridge', service: 'Shingle Roof', image: '/shingle_roofing.jpeg' },
      { title: 'Commercial Flat Roof', neighborhood: 'Orange Drive', service: 'Flat / TPO', image: '/flat_roofing.jpeg' },
      { title: 'Tile Roof Replacement', neighborhood: 'Stirling Lakes', service: 'Tile Roof', image: '/tile_roofing.jpeg' },
      { title: 'Leak Diagnosis & Repair', neighborhood: 'Pine Island Ridge', service: 'Roof Repair', image: '/shingle_roofing.jpeg' },
      { title: 'Full Re-Roof', neighborhood: 'Nova area', service: 'Shingle Roof', image: '/shingle_roofing.jpeg' },
    ],
    reviews: [
  ...
  hallandaleBeach: {
    ...
    projects: [
      { title: 'Aluminum Standing-Seam', neighborhood: 'Golden Isles', service: 'Metal Roof', image: '/metal_roofing.jpg' },
      { title: 'Clay Tile Coastal Re-Roof', neighborhood: 'Three Islands', service: 'Tile Roof', image: '/tile_roofing.jpeg' },
      { title: 'Condo TPO Flat Roof', neighborhood: 'The Hemisphere', service: 'Flat / TPO', image: '/flat_roofing.jpeg' },
      { title: 'High-Rise Roof Maintenance', neighborhood: 'Parker Dorado', service: 'Flat / TPO', image: '/flat_roofing.jpeg' },
      { title: 'Oceanfront Metal Roof', neighborhood: 'Beach Walk', service: 'Metal Roof', image: '/metal_roofing.jpg' },
      { title: 'Storm Damage Repair', neighborhood: 'Oceanview', service: 'Storm Damage', image: '/tile_roofing.jpeg' },
      { title: 'Tile Roof Replacement', neighborhood: 'Hallandale Gardens', service: 'Tile Roof', image: '/tile_roofing.jpeg' },
      { title: 'Commercial Flat Roof', neighborhood: 'Hallandale Blvd', service: 'Flat / TPO', image: '/flat_roofing.jpeg' },
      { title: 'Shingle Re-Roof (inland)', neighborhood: 'West Park', service: 'Shingle Roof', image: '/shingle_roofing.jpeg' },
      { title: 'Emergency Tarp-Up', neighborhood: 'Diplomat Landing', service: 'Storm Damage', image: '/metal_roofing.jpg' },
    ],
    reviews: [
  ...
  daniaBeach: {
    ...
    projects: [
      { title: 'Concrete Tile Re-Roof', neighborhood: 'Heritage Pointe', service: 'Tile Roof', image: '/tile_roofing.jpeg' },
      { title: 'Aluminum Standing-Seam', neighborhood: 'Jamaica Beach', service: 'Metal Roof', image: '/metal_roofing.jpg' },
      { title: 'GAF Shingle Install', neighborhood: 'Ravenswood', service: 'Shingle Roof', image: '/shingle_roofing.jpeg' },
      { title: 'Commercial TPO', neighborhood: 'Dania Pointe', service: 'Flat / TPO', image: '/flat_roofing.jpeg' },
      { title: 'Historic Tile Restoration', neighborhood: 'Downtown Dania', service: 'Tile Roof', image: '/tile_roofing.jpeg' },
      { title: 'Storm Claim Re-Roof', neighborhood: 'Dania Cove', service: 'Storm Damage', image: '/shingle_roofing.jpeg' },
      { title: 'Metal Roof Replacement', neighborhood: 'Sheridan Lakes', service: 'Metal Roof', image: '/metal_roofing.jpg' },
      { title: 'Shingle Re-Roof', neighborhood: 'Melaleuca Gardens', service: 'Shingle Roof', image: '/shingle_roofing.jpeg' },
      { title: 'Emergency Leak Repair', neighborhood: 'Port 95', service: 'Roof Repair', image: '/shingle_roofing.jpeg' },
      { title: 'Flat Roof TPO', neighborhood: 'Griffin corridor', service: 'Flat / TPO', image: '/flat_roofing.jpeg' },
    ],
    reviews: [
  ...
  aventura: {
    ...
    projects: [
      { title: 'Clay Tile Luxury Home', neighborhood: 'Turnberry Isle', service: 'Tile Roof', image: '/tile_roofing.jpeg' },
      { title: 'High-Rise TPO Roof', neighborhood: 'Williams Island', service: 'Flat / TPO', image: '/flat_roofing.jpeg' },
      { title: 'Condo Flat Roof', neighborhood: 'Point East', service: 'Flat / TPO', image: '/flat_roofing.jpeg' },
      { title: 'Custom Standing-Seam', neighborhood: 'Country Club', service: 'Metal Roof', image: '/metal_roofing.jpg' },
      { title: 'Concrete Tile Re-Roof', neighborhood: 'The Waterways', service: 'Tile Roof', image: '/tile_roofing.jpeg' },
      { title: 'Commercial Flat Roof', neighborhood: 'Aventura Mall area', service: 'Flat / TPO', image: '/flat_roofing.jpeg' },
      { title: 'Tile Roof Repair', neighborhood: 'Admirals Port', service: 'Roof Repair', image: '/tile_roofing.jpeg' },
      { title: 'Condo Tower TPO', neighborhood: 'Biscaya Island', service: 'Flat / TPO', image: '/flat_roofing.jpeg' },
      { title: 'Townhome Shingle Re-Roof', neighborhood: 'NE 29th Ave', service: 'Shingle Roof', image: '/shingle_roofing.jpeg' },
      { title: 'Metal Mansard', neighborhood: 'Aventura Marina', service: 'Metal Roof', image: '/metal_roofing.jpg' },
    ],
    reviews: [
